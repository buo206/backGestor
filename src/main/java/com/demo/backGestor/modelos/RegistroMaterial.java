...
CREATE TABLE REGISTRO_MATERIALES(
    ...
    CANTIDAD INT(10),
    FECHA DATE ,
    CONSTRAINT REGISTRO_MATERIAL  FOREIGN KEY (ID_MATERIAL) REFERENCES MATERIALES(ID_MATERIAL) ,
    CONSTRAINT REGISTRO_TRABAJOM  FOREIGN KEY (ID_TRABAJO) REFERENCES TRABAJOS(ID_TRABAJO) ,
    CONSTRAINT PK_REGISTRO_MATERIAL PRIMARY KEY (ID_MATERIAL , ID_TRABAJO)
);
 */
    @EmbeddedId
